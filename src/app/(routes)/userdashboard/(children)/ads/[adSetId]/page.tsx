...
const Ads = () => {
    ...
    useEffect(() => {
        const queryData = async () => {
            ...
            const finalList = data.filter((item: any) => item.adset_id !== adSetId);

            console.log(data)
            console.log(finalList)

            updateAdData(finalList)
        }
    ...
    return (
        <> {adData.length > 0 && adData[0].id != 'default' ?
                ...
                <TableBody>
                    {adData.map((item, index) => (
                        <TableRow key={item.id}>
                            ...
                            <TableCell>{item.preview_shareable_link}</TableCell>
                            <TableCell>
                                <div className="flex">
            ...
            </Table> : <div className="flex content-center">
                <div role="status">
